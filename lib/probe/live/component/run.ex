defmodule Probe.Live.Component.Run do
      ...
      <div class="flex w-full justify-center mb-8">
        <div class="inline-flex rounded-md shadow-sm" role="group">
          ...
          <button type="button" class={~w[
            ...
            <.icon name="hero-question-mark-circle" class="w-4 h-4 me-2" /> Other
          </button>
        </div>
      </div>
    </div>
  ...
  defp selected_class(device, selected) do
    if device == selected,
      do: "dark:bg-gray-700 text-blue-700",
      else: "dark:bg-gray-800 text-gray-900"
  end
end
